...
if __name__ == '__main__':
    '''
    folder_ref = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset037_Nuclei/labelsTs'
    folder_pred = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset037_Nuclei/output'
    output_file = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset037_Nuclei/summary.json'
    '''
    '''
    folder_ref = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset016_Prostate/labelsTs'
    folder_pred = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset016_Prostate/output'
    output_file = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset016_Prostate/summary.json'
    '''
    folder_ref = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset043_FeTS/labelsTs'
    folder_pred = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset043_FeTS/output'
    output_file = '/mnt/diskB/lyx/nnUnet_data/prostate/nnUNet_raw/nnUNet_raw_data/Dataset043_FeTS/summary.json'
